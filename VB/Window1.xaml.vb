...
Namespace ConditionalCellFormatting
	...
	Public Class ColorValueConverter
		...
		Public Function Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As CultureInfo) As Object Implements IValueConverter.Convert
			...
			Dim r As Double = color.R + (&Hff - color.R) * count / MaxValue
			Dim g As Double = color.G + (&Hff - color.G) * count / MaxValue
			Dim b As Double = color.B + (&Hff - color.B) * count / MaxValue
